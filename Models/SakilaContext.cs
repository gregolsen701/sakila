...
namespace Sakila1.Models
{
    public partial class SakilaContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.newcustomer'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-9PHMVNVS\\SQLEXPRESS;Database=Sakila;Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer2>(entity =>
            {
                ...
                entity.Property(e => e.Crcard)
                    .HasColumnName("crcard")
                    .HasMaxLength(256);
